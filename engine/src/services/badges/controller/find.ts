...
export async function findAllBadges() {
  ...
  //     img: "https://ik.imagekit.io/3592mo0vh/waffle/supportive.svg",
  //   },
  //   {
  //     title: "Contributor",
  //     desc: "Given to members who actively contribute ideas, feedback, or resources.",
  //     img: "https://ik.imagekit.io/3592mo0vh/waffle/contributor.svg",
  //   },
  //   {
  //     title: "Builder",
  //     desc: "Recognizes individuals who create and innovate through hands-on work.",
  //     img: "https://ik.imagekit.io/3592mo0vh/waffle/builder.svg",
  //   },
  // ]);
