...
export function TextHoverRevealImage({
  img,
    ...
    gsap
      .timeline({
        onStart: () => {
          ...
          if (revealInnerRef.current) revealInnerRef.current.style.opacity = "1";
  ...
  return (
    ...
    >
      <div className="menu__item-textinner pointer-events-none">{children}</div>
      <div
        ref={revealRef}
        className="hover-reveal absolute top-0 left-0 pointer-events-none aspect-[4/5] h-96"
        style={{ opacity: 0 }}
      >
        <div ref={revealInnerRef} className="hover-reveal__inner w-full h-full">
          <div
            ref={revealImgRef}
            className="hover-reveal__img w-full h-full bg-cover bg-center"
