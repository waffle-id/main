...
export function ContentReceived({ listData }: ContentReceivedProps) {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center py-12 sm:py-16 text-center">
      <Star className="size-12 sm:size-14 md:size-16 text-gray-400 mb-3 sm:mb-4" />
      <h3 className="text-lg sm:text-xl md:text-xl font-semibold text-gray-600 mb-2">No Reviews Received</h3>
